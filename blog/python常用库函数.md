...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#生成对象)生成对象

详见[数据结构简介](https://www.pypandas.cn/docs/getting_started/dsintro.html#dsintro)文档。
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#查看数据)查看数据
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#选择)选择
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#获取数据)获取数据
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#按标签选择)按标签选择
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#按位置选择)按位置选择
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#布尔索引)布尔索引
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#赋值)赋值
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#缺失值)缺失值
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#运算)运算

详见[二进制操作](https://pandas.pydata.org/pandas-docs/stable/getting_started/basics.html#basics-binop)。

### [#](https://www.pypandas.cn/docs/getting_started/10min.html#统计)统计
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#apply-函数)Apply 函数
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#直方图)直方图
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#字符串方法)字符串方法
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#合并（merge）)合并（Merge）

### [#](https://www.pypandas.cn/docs/getting_started/10min.html#结合（concat）)结合（Concat）
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#连接（join）)连接（join）
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#追加（append）)追加（Append）
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#分组（grouping）)分组（Grouping）
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#重塑（reshaping）)重塑（Reshaping）
...
### [#](https://www.pypandas.cn/docs/getting_started/10min.html#堆叠（stack）)堆叠（Stack）
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#数据透视表（pivot-tables）)数据透视表（Pivot Tables）
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#时间序列-timeseries)时间序列(TimeSeries)
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#类别型（categoricals）)类别型（Categoricals）
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#可视化)可视化
...
![可视化](C:/Users/PLR/Documents/series_plot_basic.png)
...
![可视化2](C:/Users/PLR/Documents/frame_plot_basic.png)

## [#](https://www.pypandas.cn/docs/getting_started/10min.html#数据输入-输出)数据输入 / 输出

### [#](https://www.pypandas.cn/docs/getting_started/10min.html#csv)CSV
...
## [#](https://www.pypandas.cn/docs/getting_started/10min.html#各种坑（gotchas）)各种坑（Gotchas）
